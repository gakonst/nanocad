...
Validation: five tests pass covering exact digest/reference resolution and metrics, triangle winding/unit normals/positive approximate volume, repeated instance placements, sphere pole degeneracies, warm-export equality and equality to the bundled preview. No upstream files were changed. Native app rendering and screenshot tests are separate.
